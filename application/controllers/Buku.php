...
class Buku extends CI_Controller
{
    ...
    public function hapusBuku() // Fungsi
    {
    ...
    public function ubahBuku() //Prosedur
    {
...
class LibraryManagementIntegrationTest extends TestCase
{
    private $client;
    ...
    {
        parent::setUp();
        $this->client = new LibraryManagementClient($this->config);
...
class LibraryManagementIntegrationTest extends TestCase {
    ...
    public function testLibraryFunctionality() {
        $library = new LibraryManagement(); 
        $bookData = [
            'judul_buku' => 'Buku belajar php',
            'pengarang' => 'Nur Sukma',
            'availability' => true
        ];
        $result = $library->tambahBuku($bookData);
        $this->assertTrue($result);

        $updatedData = ['title' => 'Updated Judul Buku'];
        $result = $library->updateBuku('Buku Komputer', $updatedData);
        $this->assertTrue($result);

        $deleted = $library->hapusBuku('Updated judul Buku');
